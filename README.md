# Aplicação com API Rest Countries
...
<table>
  ...
  <tr>
   <td align="center"><img alt="Interface" src="https://github.com/Emerson00Santos/Mova/blob/main/mobile1.png?raw=true" width="50%"></td>
